...
class HtmlParserTest extends \Tx_Phpunit_TestCase {
	...
	public function parseContentTestDataProvider() {
		return array(
			...
			'Images with high dpi sources are properly replaced' => array('<img src="fileadmin/secure/image.jpg" srcset="fileadmin/secure/image@2x.jpg 2x">', '<img src="securedl/fileadmin/secure/image.jpg" srcset="securedl/fileadmin/secure/image@2x.jpg 2x">'),
			'Images with high dpi sources and duplicate fallback source are properly replaced' => array('<img src="fileadmin/secure/image.jpg" srcset="fileadmin/secure/image.jpg, fileadmin/secure/image@2x.jpg 2x">', '<img src="securedl/fileadmin/secure/image.jpg" srcset="securedl/fileadmin/secure/image.jpg, securedl/fileadmin/secure/image@2x.jpg 2x">'),
			'Images with multiple high dpi sources are properly replaced' => array('<img src="fileadmin/secure/image.jpg" srcset="fileadmin/secure/image@2x.jpg 2x, fileadmin/secure/image@3x.jpg 3x">', '<img src="securedl/fileadmin/secure/image.jpg" srcset="securedl/fileadmin/secure/image@2x.jpg 2x, securedl/fileadmin/secure/image@3x.jpg 3x">'),
			'Responsive images are properly replaced' => array('<img src="fileadmin/secure/image.jpg" srcset="fileadmin/secure/image200.jpg 200w, fileadmin/secure/image400.jpg 400w">', '<img src="securedl/fileadmin/secure/image.jpg" srcset="securedl/fileadmin/secure/image200.jpg 200w, securedl/fileadmin/secure/image400.jpg 400w">'),
			'Picture sources (high dpi) are properly replaced' => array('<source srcset="fileadmin/secure/image@1x.jpg 1x, fileadmin/secure/image@2x.jpg 2x">', '<source srcset="securedl/fileadmin/secure/image@1x.jpg 1x, securedl/fileadmin/secure/image@2x.jpg 2x">'),
			'Picture sources (responsive) are properly replaced' => array('<source srcset="fileadmin/secure/image200.jpg 200w, fileadmin/secure/image400.jpg 400w">', '<source srcset="securedl/fileadmin/secure/image200.jpg 200w, securedl/fileadmin/secure/image400.jpg 400w">'),
